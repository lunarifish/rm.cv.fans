...
class SimpleRotateCounter {
 public:
  SimpleRotateCounter(const int& armor_cnt, const double& jump_angle, const double& min_active_rotate);
 ...
 private:
  ...
  aimer::AngleFilter<1, 2> theta_s_filter{2. * M_PI, {0.01, 10., 10.}, aimer::RESERVED_DOUBLE};
...
struct OrientationSignFixerConstructor {
  OrientationSignFixerConstructor(const double& reset_time, const double& sampling_time, const double& reserving_range)
